...
public class HadolintSensorTest {
    ...
    private static final String PROPERTY_ACTIVATE = "sonar.hadolint.activated";
    private static final String PROPERTY_REPORT_PATH = "sonar.hadolint.reports.path";
    private static final String PROPERTY_DOCKERFILE_PATH = "sonar.hadolint.dockerfiles.path";
    ...
    @Test
	public void testDefaultDeactivated() {
        // Active property not set
    ...
    @Test
	public void testManualDeactivated() {
        // Manually set activate property to false
        MapSettings settings = new MapSettings();
        settings.setProperty(PROPERTY_ACTIVATE, false);
    ...
    @Test
	public void testActivatedNoReportFilesNoDockerfiles() {
        // Manually set activate property to true
        // Path for reports and Dockerfiles empty
        MapSettings settings = new MapSettings();
        settings.setProperty(PROPERTY_ACTIVATE, true);
        settings.setProperty(PROPERTY_REPORT_PATH, "");
        settings.setProperty(PROPERTY_DOCKERFILE_PATH, "");
        context.setSettings(settings);
	...
	public void testNormalWork() {
        ...
        settings.setProperty(PROPERTY_DOCKERFILE_PATH, DOCKERFILE_PATH);
        context.setSettings(settings);
	...
	public void testDockerfileNotFound() {
        ...
        settings.setProperty(PROPERTY_ACTIVATE, true);
        settings.setProperty(PROPERTY_REPORT_PATH, REPORT_PATH);
        settings.setProperty(PROPERTY_DOCKERFILE_PATH, "Dockerfile_not_exist");
        context.setSettings(settings);
